...
const HotelReg = () => {
  return (
    <div className='fixed top-0 bpttom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70'>
      <form className='flex bg-white rounded-x max-w-4xl max-md:mx-2'> 
