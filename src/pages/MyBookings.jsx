...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <Titel title="My Bookings" subtitle="Easily manage your past, current, and upcomming hotel reservation in one place. Plan your trips sealessly with just a few clicks." align='left' />
